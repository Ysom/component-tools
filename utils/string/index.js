 ...
 * @param {string} config.source 需要解析的源文本
 * @param {string} config.tag 需要解析元素的tagName
 * @param {object} [config.attrs={}] 附加属性添加更快查询解析元素，可选
 * @returns {Array}
 */
 ...
 * @param {string} config.source 需要解析的源文本
 * @param {string} config.tag 需要解析元素的tagName
 * @param {string} config.attr 需要获取属性值的解析元素的属性名称
 * @param {object} [config.attrs={}] 附加属性添加更快查询解析元素
 * @returns {Array}
 */
